...
Data from the extended mouse atlas [@gottgens2023] was used to train the automated annotation model. This can be accessed from <https://marionilab.github.io/ExtendedMouseAtlas/#data>.
